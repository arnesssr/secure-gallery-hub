  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-white/90 dark:bg-charcoal/90 backdrop-blur-sm py-4 shadow-sm" // Increased padding from py-3 to py-4
          : "bg-transparent py-6" // Increased padding from py-4 to py-6
      }`}
    >
